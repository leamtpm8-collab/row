...
export const config = {
  matcher: ['/((?!login\\.html|api/login|api/logout|api/nutrition-sync|api/push-send|tools/|icons/|manifest\\.json).*)'],
};

const EXEMPT_PATHS = new Set(['/login.html', '/api/login', '/api/logout', '/api/nutrition-sync', '/api/push-send', '/manifest.json']);
